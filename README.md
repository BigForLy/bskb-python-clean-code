...
1. Максимальная длина функции 60 строк
2. Использовать минимум аргументов в функции, не использовать в аргументах переменные-флаги
3. Функции должны делать одно
-----------
